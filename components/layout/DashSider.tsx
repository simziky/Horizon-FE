...
import UPCScannerIcon from "@/public/assets/svg/icons/upc-scanner-icon";
...
const TotanAIIcon = dynamic(
  () => import("@/public/assets/svg/icons/totan-ai-icon"),
  {
    ssr: false,
    loading: () => (
      <span className="inline-block rounded bg-gray-200 size-6" />
    ),
  }
);
